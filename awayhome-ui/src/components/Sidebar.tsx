...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-gray-200  no-scrollbar">
      <div className="filter p-4 bg-[#61988E] text-white shadow-md border border-gray-400 rounded-lg">
        ...
        <form>
          ...
          <button
            type="submit"
            className="w-full bg-white text-[#61988E] font-bold py-2 rounded-md"
          >
            Search
          </button>
        </form>
