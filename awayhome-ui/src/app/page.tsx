      ...
      <div className="container mx-auto flex flex-col items-center md:flex-row">
        <div className="md:w-1/2 p-4">
          ...
          <p className="mt-4 text-gray-600">
            ...
            eros ac nisl pharetra auctor nec a urna. Mauris hendrerit diam
            dolor, ut euismod sapien accumsan in.
          </p>
          <button className="mt-6 px-6 py-2 bg-blue-900 text-white rounded">
            Contact Us
          </button>
        </div>
